...
comp_df <- map_df(seq_along(comp_yamls), function(i) {
  ...
  authors <- map_df(auths, function(aut) {
    tibble(
      ...
      github = ifelse(is.null(aut$props$github), "", paste0(" <a href='https://github.com/", aut$author$github, "'><img src='resources/github_mark.svg' height='16'></a>")),
      md = paste0(name, orcid, github)
    )
  })
...
comp_df %>% 
  ...
  transmute(
    ...
    Team = team_name,
    `Method name` = glue::glue("[{method_label}]({conf})"),
